//
//  ChartRewardsViewController.swift
//  citZen
//
//  Created by Domenico Varchetta on 06/06/2020.
...
class ChartRewardsViewController: UIViewController, UICollectionViewDataSource,UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
	...
	func loadPoints(){
		...
		refDatabase.child(uid!).observeSingleEvent(of: .value, with: { snap in
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "chartBadgesCell", for: indexPath) as! ChartBadgesCollectionViewCell
